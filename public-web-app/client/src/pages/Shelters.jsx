      ...
      <SidebarInset>
        ...
        <main className="flex-1 px-4 py-8 dark:from-gray-900 dark:to-gray-800 min-h-screen">
          <div className="max-w-4xl mx-auto space-y-8">
            <ScrollArea className="h-[700px] w-full pr-2">
              {/* Map Section */}
              <section>
                <h2 className="text-lg font-bold mb-2 text-blue-700 dark:text-blue-300 flex items-center gap-2"><MapPin className="h-5 w-5" />Shelters Map</h2>
              ...
              {/* List Section */}
              <section>
                <h2 className="text-lg font-bold mb-2 text-blue-700 dark:text-blue-300">Shelter List</h2>
                {loadingRelated ? (
