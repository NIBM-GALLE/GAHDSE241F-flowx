...
export default function NewVictimRequests() {
  ...
  const handleUpdate = async () => {
    ...
    setUpdating(true);
    await updateRequestStatus({ role, victim_request_id: selectedRequest.victim_request_id, status });
    setUpdating(false);
      ...
      <SidebarInset>
        ...
        <main className="flex-1 px-4 py-6 md:px-8 md:py-8 bg-gray-50 dark:bg-gray-900 space-y-8">
          ...
          <Card className="bg-white dark:bg-gray-800 border dark:border-gray-700">
            <CardHeader>
              <CardTitle>New Victim Requests</CardTitle>
            </CardHeader>
                      ...
                      <tr key={req.victim_request_id} className="border-b dark:border-gray-700">
                        ...
                        <td className="px-4 py-2 text-right">
                          <Button size="sm" variant="outline" onClick={() => {
                            ...
                            setStatus(req.victim_request_status || "pending");
          ...
          <Dialog open={!!viewModalOpen} onOpenChange={setViewModalOpen}>
            <DialogContent className="max-w-lg">
              ...
              {role === 'grama_sevaka' && selectedRequest && (
                <div className="mt-4">
