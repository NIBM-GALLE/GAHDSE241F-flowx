  ...
  return (
    <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 p-6 flex flex-col gap-3 transition-transform hover:scale-[1.02] hover:shadow-2xl">
      ...
      <div className="absolute top-2 right-2">
        <span className="rounded-full bg-green-100 dark:bg-green-900 px-3 py-1 text-xs font-semibold text-green-700 dark:text-green-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {loading ? (
              <div className="col-span-full flex justify-center items-center h-40">
                ...
                <span className="ml-3 text-green-500 font-semibold">Loading...</span>
              </div>
            ) : error ? (
              <div className="col-span-full text-center text-red-500 font-semibold">{error}</div>
            ) : approvedRequests.length === 0 ? (
              <div className="col-span-full text-center text-gray-400 dark:text-gray-500">No approved requests.</div>
            ) : (
